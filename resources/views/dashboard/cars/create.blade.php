...
@section('pageTitle', 'Create a new Car')
                        ...
                        <div class="page-content-wrapper">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Create a new Car</h4>
                                                            ...
                                                            <div class="mb-3 row">
                                                                <div class="col-md-10">
                                                                    <select name="transmission_type"
                                                                            class="form-select @error('transmission_type') is-invalid @enderror"
                                                                            aria-label="Default select example"
                                                                            required>
                                                                        <option selected disabled>Transmission Type
                                                                        </option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3 form-group">
                                                            ...
                                                            <p style="font-size: xx-small; color:red;">EX:
                                                                971XXXXXXX</p>
                                                            <input type="text"
