...
@section('pageTitle', 'Edit Car - '.$car->maker.' '.$car->model.' '.$car->year)
                        ...
                        <div class="page-content-wrapper">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Edit Car - {{$car->maker}} {{$car->model}} {{$car->year}}</h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3 form-group">
                                                            ...
                                                            <div class="mb-3 row">
                                                                <div class="col-md-10">
                                                                    <select name="transmission_type" class="form-select" aria-label="Default select example" required>
                                                                        ...
                                                                        <option value="Automatic"
                                                                            {{$car->transmission_type == "Automatic" ? "selected" : ""}}>Automatic</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3 form-group">
                                                            ...
                                                            <p style="font-size: xx-small; color:red;">EX: 971XXXXXXX</p>
                                                            <input type="text"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3 form-group">
                                                            ...
                                                            <p style="font-size: xx-small; color:red;">EX: 27XXXXXXX</p>
                                                            <input type="text"
                                                                   class="form-control @error('price_africa') is-invalid @enderror"
                                                                   id="whatsapp_uae"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3 form-group">
                                                            <div class="form-check form-switch mb-3">
                                                                <input type="checkbox"
                                                                       class="form-check-input theme-choice" id="light-mode-switch"
                                                                       name="warranty"
                                                                    ...
                                                                    <div class="grid-img">
                                                                        <div class="wrapper">
                                                                            <div class="file-upload-multi">
                                                                                <input name="car_images[]" id="files" type="file" multiple/>
